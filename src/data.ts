...
export const PRODUCT_FEATURES: ProductFeature[] = [
  ...
  {
    id: "capacidade",
    title: "Capacidade Termo-Regulável",
  ...
  },
  {
    ...
    description: "Trabalhamos com projetos personalizados e sob medida. Adaptamos o sistema e o visual vintage que traz a nostalgia do verdadeiro sorvete americano, ajustado às suas necessidades.",
    icon: "Sliders"
  },
  {
    id: "instrucoes",
    title: "Suporte Total & Receita Inclusa",
    description: "Fornecemos receitas completas originais e instruções minuciosas de uso. Suporte pós-venda garantido para você dar a largada e alavancar suas vendas no primeiro dia.",
    icon: "BookOpen"
  },
  {
    id: "formula",
    title: "Fórmula de 50 Anos de Sucesso",
    description: "Desenvolvida pelo Sr. Aurélio Pelagio, nossa receita carrega o sabor autêntico da infância, combinando o melhor do sorvete estilo americano com alta cremosidade e picolés incomparáveis.",
    icon: "Sparkles"
  }
];
...
export const INSTAGRAM_POSTS: InstagramPost[] = [
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/popsicle/540/960",
    likes: 852,
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/retroicecream/540/960",
    likes: 2130,
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/gelatoclient/540/960",
    likes: 981,
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/retrocone/540/960",
    likes: 1540,
