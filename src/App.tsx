          ...
          <div className="relative w-full py-4 group/slider">
            ...
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex justify-between z-20 pointer-events-none px-2 sm:px-6">
              <button
                ...
                className="pointer-events-auto w-10 h-10 rounded-full bg-white/90 border border-slate-200 text-slate-800 flex items-center justify-center hover:bg-white active:scale-95 transition-all shadow-md cursor-pointer"
                aria-label="Anterior"
              >
