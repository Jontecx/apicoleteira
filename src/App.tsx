          ...
          <div className="relative w-full overflow-hidden py-4">
            ...
            <div className="animate-marquee flex gap-6 hover:[animation-play-state:paused] whitespace-nowrap">
              {[...INSTAGRAM_POSTS, ...INSTAGRAM_POSTS].map((post, index) => (
                ...
                >
                  {/* Polaroid Frame - Ultra high performance 0ms Grey Block with Center Text */}
                  <div className="relative aspect-[9/12] bg-slate-100 rounded-[16px] shrink-0 flex flex-col items-center justify-center p-4 border border-slate-200/80 overflow-hidden">
                    <span className="text-xs font-black text-slate-400 uppercase tracking-widest font-mono text-center">
                      fotos clientes
                    </span>
                    
                    <div className="absolute top-2.5 right-2.5 z-10 bg-[#222222]/90 text-blue-400 text-[8px] font-mono font-black py-0.5 px-2 rounded select-none">
                      {post.growth}
                    </div>
                    ...
                    <div className="absolute bottom-3.5 inset-x-3 z-20 text-white whitespace-normal text-left">
                      <div className="flex items-center gap-1 mb-1 opacity-95">
                  ...
                  {/* Clean info area - completely static initials badge for 0ms loading time, no directing links and no @ symbols */}
                  <div className="mt-3.5 pt-3.5 border-t border-slate-100 flex items-center gap-2">
                    <div className="w-7 h-7 rounded-full bg-slate-200 text-slate-600 flex items-center justify-center font-mono text-[9px] font-black border border-slate-300 shrink-0 select-none">
